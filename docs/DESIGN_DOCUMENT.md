...
ModelRegistryEntry(
    ...
    endpoint="https://YOUR_AZURE_ENDPOINT.cognitiveservices.azure.com/openai/responses",
...
ModelRegistryEntry(
    ...
    endpoint="https://YOUR_AZURE_ENDPOINT.cognitiveservices.azure.com/openai/deployments/qrg-embedding-experimental/embeddings",
