    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <div className="relative max-w-md">
          ...
          />
          <input
            className="w-full rounded-md border border-surface-border bg-surface-raised py-2 pl-9 pr-3 text-sm text-gray-200 placeholder-gray-600 focus:border-purple-500 focus:outline-none"
            ...
            {recentSessions.map((s, i) => {
              ...
              return (
                <button
                  key={i}
                  onClick={() => openApp(app)}
                  className="flex shrink-0 items-center gap-2 rounded-lg border border-surface-border bg-surface-raised px-4 py-2.5 transition-colors hover:border-purple-500/40"
                >
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {apps.map((app) => (
                <button
                  ...
                  onClick={() => openApp(app)}
                  className={cn(
                    "flex flex-col items-start rounded-lg border border-surface-border bg-surface-raised p-5 text-left transition-colors hover:border-purple-500/40",
                  )}
                >
